  ...
  return (
    <div className="min-h-screen bg-[#020205] text-slate-300 font-mono flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <Link
          href="/dashboard"
          className="w-full py-3 px-4 rounded-xl bg-red-500 hover:bg-red-600 text-black font-bold text-xs tracking-widest uppercase transition-all flex items-center justify-center gap-2"
        >
